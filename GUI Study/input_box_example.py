...
class MyGUI:
    def __init__(self):   
        ...
        self.label1 = tkinter.Label(
            self.labels_frame1, text="label 1.2 text", font= ("Helvetica", 10, "bold")
        )

        self.label2 = tkinter.Label(
            self.labels_frame1, text="label 1.1 text", font= ("Helvetica", 10, "bold")
        )
        
        self.label3 = tkinter.Label(
            self.labels_frame2, text="label 2 text", font= ("Helvetica", 10, "bold")
        )
